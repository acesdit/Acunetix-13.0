...
const eventsData = [
    ...
    },
    {
        ...
        categoryIcon: '🐛',
        poster: '', // Bugbounty.webp not found, set to empty or provide a valid image
        description:
    ...
    },
    {
        ...
        category: 'Hackathon',
        categoryIcon: '🚀',
        poster: '', // build-a-thon.webp not found, set to empty or provide a valid image
        description:
    ...
    },
    {
        ...
        categoryIcon: '🎮',
        poster: '', // GameStorm.webp not found, set to empty or provide a valid image
        description:
